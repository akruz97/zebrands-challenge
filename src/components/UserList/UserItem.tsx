    ...
    return (
            <Pressable key={index}>
                ...
                <Text className="px-2 py-2 font-bold text-center" 
                        allowFontScaling  
                        adjustsFontSizeToFit >{item.login}</Text>
                    ...
                    <View className="flex-row ">
                        ...
                        <View className="px-2 flex-1">
                            <Text className="text-sm text-slate-700" numberOfLines={2}>{item.type}</Text>
                            <Text className="text-sm text-slate-700" numberOfLines={2}>{item.user_view_type}</Text>
